'''
Code is altered slightly from the original (PUBLIC DOMAIN) version by a Mr Robert Stein:
(https://github.com/SteinRobert)
Link is provided out of respect, all code below is 'un-licensed' and completely free for use.
'''
# -*- coding: utf-8 -*-
import requests
import json
